...
public class Ej5 {
     public static void main(String[] args) {
        ...
        while ((dL<dF)&&!(visitante.equals("ZZZ"))) {
            System.out.println("Ingrese el equipo local");
            local=Lector.leerString();
            p[dL]=new Partido(local,visitante,GeneradorAleatorio.generarInt(10),GeneradorAleatorio.generarInt(10));
            dL++;
            System.out.println("Ingrese el equipo visitante");
            visitante=Lector.leerString();
        }
        ...
        for (int i = 0; i < dL; i++) {
            ...
            if(p[i].getLocal().equals("Boca"))
                bocaLocal+=p[i].getGolesLocal();
        }
        
        System.out.println("                   ");
        System.out.println("La cantidad de partidos ganador por River es de "+cantRiver);
        System.out.println("La cantidad de goles realizados por Boca de local es "+bocaLocal);
    }
}
