...
public class Ej2 {
     public static void main(String[] args) {
        ...
        Estacionamiento e=new Estacionamiento("Estrella","Calle 5 777","12:12","21:21",3,3 );
        for(int i=1;i<=3;i++){
            for(int j=1;j<=3;j++){
                Auto a=new Auto(GeneradorAleatorio.generarString(12),GeneradorAleatorio.generarString(6));
                e.registrarAuto(i, j, a);
            }
        }
        
        System.out.println(e.toString());
        System.out.println("La cantidad de autos ubicados en la plaza 1 es "+e.contarPlaza(1));
        
        System.out.println("Ingrese una patente");
        String patente=Lector.leerString();
        System.out.println(e.retornarPosicion(patente));//No hace nada
    }
}
