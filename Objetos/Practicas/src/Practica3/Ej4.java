...
public class Ej4 {
    public static void main(String[] args) {
        ...
        int i;
        for (i = 0; i < 5; i++) {
            Persona client=new Persona(GeneradorAleatorio.generarString(10),GeneradorAleatorio.generarInt(44000000),GeneradorAleatorio.generarInt(99)+1);
            int hab=GeneradorAleatorio.generarInt(5)+1;
            hotel.ingresarCliente(client, hab);
        }
        
        System.out.println(hotel.toString());
        
        for(i=0;i<hotel.getN();i++)
            hotel.aumentarPrecios(GeneradorAleatorio.generarDouble(500)+1);
