...
public class Ej2 {
       public static void main(String[] args) {
        Autor autor=new Autor("Herbert Schildt","Sin biografia.","Sin informacion.");
        Autor autor2=new Autor("John Horton","Sin biografia.","Sin informacion.");
        ...
        System.out.println("               ");
        System.out.println("Autor del libro 1: ");
        System.out.println(autor.toString());
        System.out.println("               ");
